...
export const CATEGORY_MASTER_DNA = {
  ...
  infographic_ai: {
    ...
    environmentStyle: 'Clean pastel infographic canvas, product on pedestal, soft gradients, doodle arrows, benefit cards, readable Thai typography, safe claim structure.',
